...
Учебный starter AI Room Club для проекта типа «мини-CRM, трекер задач или внутренняя платформа».

[Use this template](https://github.com/FocusSam/airc-vibe-workspace/generate) · [Live demo](https://focussam.github.io/airc-vibe-workspace/) · [Release v1.0.0](https://github.com/FocusSam/airc-vibe-workspace/releases/tag/v1.0.0)
...
- `#/workspace` — рабочая доска и создание записи.
